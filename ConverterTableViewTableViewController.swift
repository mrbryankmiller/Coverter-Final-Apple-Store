...
class ConverterTableViewTableViewController: UITableViewController, UITextFieldDelegate {
 ...
 let button = UIButton(type: UIButtonType.Custom)
    ...
    //    convert to Belize
        ...
        myDefaults.setObject(dollarAmountTextfield.text!, forKey: "dollarAmount")
    ...
    override func viewDidLoad() {
        ...
        if NSUserDefaults.standardUserDefaults().objectForKey("dollarAmount") != nil {
            
            let saveText = NSUserDefaults.standardUserDefaults().objectForKey("dollarAmount") as! String
            
            dollarAmountTextfield.text = saveText
